...
const SideBar = () => (
    ...
    <ul className="menu-inner py-1">
      ...
      <li><span className="menu-headerr-text"></span></li> 
      <NavLink to={"/laboratories"} className="menu-item" activeClassName="active">
      <li className="menu-link  ">
          <i className="menu-icon tf-icons bx bx-home-circle"></i>
      ...
      {/* <!-- Layouts --> */}
      <li ><span className="menu-headerr-text"></span></li>
      <NavLink to={"/addlabtest"} className="menu-item" activeClassName="active">
       <li className="menu-link">
      ...
      <li><span className="menu-headerr-text"></span></li>
      <NavLink to={"/createtestcombos"} className="menu-item" activeClassName="active">
       <li className="menu-link">
      ...
      <li><span className="menu-header-text"></span></li> 
        ...
        <NavLink to={"/addnewworkers"} className="menu-item" activeClassName="active">
         <li className="menu-link">
      ...
      <li ><span className="menu-headerr-text"></span></li> 
        <NavLink to={"/seebookings"} className="menu-item">
          <li className="menu-link">
            <i className="menu-icon tf-icons bx bx-user"></i>
            <div data-i18n="See Bookingss">See Bookings</div>
          </li>
        </NavLink>

      <li><span className="menu-headerr-text"></span></li> 
        <NavLink to={"/mobileappusers"} className="menu-item" activeClassName="active">
          <li className="menu-link">
           <i className="menu-icon tf-icons bx bx-check-shield"></i>
          <div data-i18n="See Mobile App User">See Mobile App Users</div>
          </li>
        </NavLink>
      ...
      <li><span className="menu-headerr-text"></span></li> 
        <NavLink to="/labreports" className="menu-item" activeClassName="active"> 
          <li className="menu-link">
            <i className="menu-icon tf-icons bx bx-dock-top"></i>
           <div data-i18n="Laboratory Reports">Laboratory Reports</div>
           </li> 
        </NavLink>
    

       <li><span className="menu-headerr-text"></span></li> 
        <NavLink to="/usersreports" className="menu-item" activeClassName="active">
          <li className="menu-link">
            <i className="menu-icon tf-icons bx bx-user-voice"></i>
            <div data-i18n="Report from Users">Report from Users</div>
          </li> 
        </NavLink>
    </ul> 
